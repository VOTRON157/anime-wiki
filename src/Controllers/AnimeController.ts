        ...
        this.instance(`anime?filter[id]=${animeId}`).then(response => {
            ...
            fetch(`https://gogoanime.consumet.stream/vidcdn/watch/${anime.attributes.slug}-episode-${episode}`)
                ...
                .then(async (animelist) => {
                    let temDublado = {}
                    const servers = [`https://video.serverotaku01.co/010/animes/${anime.attributes.slug.at(0)}/${anime.attributes.slug}-dublado/${episode < 10 ? '0' + episode : episode}.mp4`, `https://hls.servertv001.com/animes/${anime.attributes.slug}-dublado/${episode < 10 ? '0' + episode : episode}.mp4`, `https://video.servertv001.com/animes/${anime.attributes.slug.at(0)}/${anime.attributes.slug}-dublado/${episode < 10 ? '0' + episode : episode}.mp4`, `https://video.servertv001.com/animes/${anime.attributes.slug.at(0)}/${anime.attributes.slug}/${episode < 10 ? '0' + episode : episode}.mp4`, `https://hd.servertv001.com/animeshd/${anime.attributes.slug.at(0)}/${anime.attributes.slug}/${episode < 10 ? '0' + episode : episode}.mp4`, `https://hd3.servertv001.com/animeshd/${anime.attributes.slug.at(0)}/${anime.attributes.slug}/${episode < 10 ? '0' + episode : episode}.mp4`, `https://hd2.servertv001.com/animeshd/${anime.attributes.slug.at(0)}/${anime.attributes.slug}/${episode < 10 ? '0' + episode : episode}.mp4`, `https://lightspeedst.net/s1/mp4/${anime.attributes.slug}-dublado/sd/${episode}.mp4`, `https://lightspeedst.net/s2/mp4/${anime.attributes.slug}-dublado/sd/${episode}.mp4`, `https://lightspeedst.net/s3/mp4/${anime.attributes.slug}-dublado/sd/${episode}.mp4`, `https://lightspeedst.net/s4/mp4/${anime.attributes.slug}-dublado/sd/${episode}.mp4`, `https://lightspeedst.net/s5/mp4/${anime.attributes.slug}-dublado/sd/${episode}.mp4`]
